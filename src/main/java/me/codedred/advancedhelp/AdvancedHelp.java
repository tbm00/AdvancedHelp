	...
	private void checkForUpdates() {
        ...
        try {
            //if (updater.checkForUpdates()) {
                ...
                getServer().getConsoleSender().sendMessage(ChatColor.AQUA + "You are using an unofficial version of AdvancedHelp,");
				getServer().getConsoleSender().sendMessage(ChatColor.AQUA + "updated for Java 17 by tbm00!");
                getServer().getConsoleSender().sendMessage(ChatColor.AQUA + "Find the official version here:");
